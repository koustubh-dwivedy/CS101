...
/**
Task: Finding the eigenvalues of a martix WHOSE QR transformation is possible AND whose eigenvalues ARE NOT COMPLEX.
Input: Any Matrix;
OUTPUT: A matrix of order 1xn where n is the number of eigenvalues.
**/
